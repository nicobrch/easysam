...
def button(children, variant="primary", size="default", disabled=False,
    ...
    # Base button classes
    base_classes = "inline-flex items-center justify-center rounded text-xs font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50 cursor-pointer"
